const styles = {
  ...
  dateBtn: ({ hasDate }: { hasDate: boolean }) => `border border-arcx-gray-300 rounded p-2 text-arcx-gray-600 w-full focus:outline-none text-left ${!hasDate ? 'opacity-60' : ''} leading-6`,
